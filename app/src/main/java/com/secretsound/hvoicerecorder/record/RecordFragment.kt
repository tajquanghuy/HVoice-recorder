package com.secretsound.hvoicerecorder.record
...
import com.secretsound.hvoicerecorder.R
import com.secretsound.hvoicerecorder.data.Record
import com.secretsound.hvoicerecorder.databinding.FragmentRecordBinding
import com.secretsound.hvoicerecorder.iap.activities.IAPActivity
import com.secretsound.hvoicerecorder.utils.RecordState
...
class RecordFragment : Fragment(R.layout.fragment_record) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recordBinding.tvSub.setOnClickListener {
            startActivity(Intent(requireActivity(), IAPActivity::class.java))
        }
    }
